...
class GRPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        use_em_loss (`bool`, *optional*, defaults to `False`):
            Use negative trajectory level entropy as the reward.
    ...
    use_em_loss: bool = field(
        default=False,
        metadata={"help": "Whether to use Negative Entropy Trajectory Level loss."},
    )
